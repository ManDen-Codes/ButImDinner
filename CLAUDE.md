...
- `training/train.py` — QLoRA fine-tune Qwen3.5 4B using Unsloth
...
- Qwen3.5 4B has no HuggingFace license gate — downloads freely
- For laptop inference, build llama-cpp-python with Vulkan support or use a prebuilt wheel
